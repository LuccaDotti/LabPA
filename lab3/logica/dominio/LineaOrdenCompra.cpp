...
LineaOrdenCompra::LineaOrdenCompra(Producto* producto, ProveedorProducto* proveedorProducto, int cantidad, float precioUnitario) : ordenCompra(nullptr), producto(producto), proveedorProducto(proveedorProducto), cantidad(cantidad), precioUnitario(precioUnitario) {}
